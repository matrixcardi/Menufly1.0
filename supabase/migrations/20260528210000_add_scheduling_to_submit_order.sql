-- Update submit_order function to handle scheduling parameters

-- Drop the current function
DROP FUNCTION IF EXISTS public.submit_order(uuid, text, text, text, text, text, jsonb, text, text, uuid, uuid[], numeric);

-- Recreate with scheduling parameters
