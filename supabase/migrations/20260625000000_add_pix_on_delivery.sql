-- Add pix_on_delivery_enabled to restaurants
ALTER TABLE public.restaurants
  ADD COLUMN IF NOT EXISTS pix_on_delivery_enabled boolean NOT NULL DEFAULT true;

-- Update submit_order to accept 'pix_delivery' as a valid payment method
...
BEGIN
  ...
  IF p_payment_method NOT IN ('pix', 'cash', 'card', 'pix_delivery') THEN
